...
# you can commit the changes in your local `tanssi-docs` repo!    #
# And that's it!                                                  #
...
print(
    "✅ Compressing images completed, please check out your local tanssi-docs directory to see the changes"
)
